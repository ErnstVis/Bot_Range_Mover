...
for val in discr:
    ...
    class Scan_window(Base):
        __tablename__ = "scan_window_" + str(val)
    ...
    ax1.plot(timestamp_list, price_1_list, color="#DBB5389E", linewidth=1)
    ...
    ax1.plot(timestamp_list, prices_act_min, color="magenta", linewidth=1)
    ax1.plot(timestamp_list, prices_act_max, color="magenta", linewidth=1)
    # =================================================================================== SIMPLE INDICATORS
    # ax1.plot(x, IND_sma1_list, color="#FFFB23", linewidth=1)
    # ax1.plot(x, IND_sma3_list, color="#FFA500", linewidth=1)
    # =================================================================================== COMPLEX INDICATORS
    ax2 = ax1.twinx()
    ax2.plot(timestamp_list, gross_1_list, color="#5DAF00AB", linewidth=1)
    ax2.plot(timestamp_list, gross_2_list, color="#027E2B9D", linewidth=1)

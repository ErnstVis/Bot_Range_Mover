...
ax1.plot(x, prices_min, color="magenta", linewidth=2)
ax1.plot(x, prices_max, color="magenta", linewidth=2)
ax1.plot(x, prices_teo_min, color="green", linewidth=2)
ax1.plot(x, prices_teo_max, color="green", linewidth=2)
